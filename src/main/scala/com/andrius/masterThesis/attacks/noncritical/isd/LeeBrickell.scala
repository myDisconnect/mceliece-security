...
/**
  * Implementation of Lee-Brickell algorithm
  *
  ...
  * @see Information-set decoding for linear codes over Fq (https://eprint.iacr.org/2009/589.pdf)
  ...
  * @todo delete below
  *       READ THE WHOLE THING: https://trac.sagemath.org/ticket/20138
  *       Impl: https://github.com/sagemath/sage/blob/07d6c37d18811e2b377a9689790a7c5e24da16ba/src/sage/coding/information_set_decoder.py
  *       Examples: https://christianepeters.files.wordpress.com/2012/10/20090401-eipsi.pdf
  */
class LeeBrickell(publicKey: BCMcEliecePublicKey) {
  ...
  /**
    * Also known as Generalized Information-Set Decoding Attack (GISD attack)
    *
    * @param c cipher
  ...
  /**
    ...
    *
    * @param c cipher
    * @return A nearest codeword of t Hamming distance from c
    */
